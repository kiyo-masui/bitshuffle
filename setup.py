...
ext_bshuf = Extension("bitshuffle.ext",
                   ["bitshuffle/ext.pyx", "src/bitshuffle.c", "src/bshuf_lz4.c", "src/iochain.c", "lz4/lz4.c"],
                   include_dirs=INCLUDE_DIRS + [np.get_include(), "src/",
                                                "lz4/"],
                   library_dirs = LIBRARY_DIRS,
                   depends=["src/bitshuffle.h", "src/bshuf_lz4.h", "src/iochain.h", "lz4/lz4.h"],
                   libraries = ['gomp'],
...
h5filter = Extension("bitshuffle.h5",
                   ["bitshuffle/h5.pyx", "src/bshuf_h5filter.c",
                    "src/bitshuffle.c", "src/bshuf_lz4.c", "src/iochain.c", "lz4/lz4.c"],
                   include_dirs=INCLUDE_DIRS + ["src/", "lz4/"],
                   library_dirs = LIBRARY_DIRS,
                   depends=["src/bitshuffle.h", "src/bshuf_lz4.h", "src/iochain.h",
